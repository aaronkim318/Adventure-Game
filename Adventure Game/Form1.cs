...
namespace Adventure_Game
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            option1Label.Text = "use the bike";
            option2Label.Text = "run instead";
        }
        ...
        private void option1Button_Click(object sender, EventArgs e)
        {
            ...
            else if (page == 9) { page = 97;}
            else if (page == 10) { page = 98;}
            ...
            switch(page)
            {
                ...
                case 4:
                    ...
                    option1Label.Text = "You give them everything";
                    option2Label.Text = "You give them the turnip.";
                    // option3Label.Text = "You try and run away. they catch you and beat you up so bad " +
                    // that you get hospitalized.";
                    break;
                case 5:
                ...
                case 17:
                    outputLabel.Text = "you picked up the 10$ bill and as you're happily running to school you come across the lady from the light." +
                        ...
                        "You try and apologize to the lady but her sons deliquent gang comes and takes all your money  and beat you up. " +
                        "You are late for clas. Play Again?"; 
                    option1Label.Text = "Yes";
                    option2Label.Text = "No";
                    break;
                case 18:
        ...
        private void option2Button_Click(object sender, EventArgs e)
        {
            ...
            else if (page == 7) { page = 8; }//NOT DONE 
